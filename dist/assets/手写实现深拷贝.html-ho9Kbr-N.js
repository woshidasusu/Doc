import{_ as l,r as d,o as a,c as r,a as e,b as i,e as s,d as v}from"./app-Zf-yBXw2.js";const c={},u=e("h1",{id:"手写实现深度拷贝",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#手写实现深度拷贝","aria-hidden":"true"},"#"),i(" 手写实现深度拷贝")],-1),t={href:"https://muyiy.cn/blog/4/4.3.html",target:"_blank",rel:"noopener noreferrer"},b=v(`<h3 id="基础理论" tabindex="-1"><a class="header-anchor" href="#基础理论" aria-hidden="true">#</a> 基础理论</h3><p>拷贝的基础是赋值，在 js 中，将一个变量赋值给另一个变量时，有两种场景：</p><ul><li>基本类型数据的值拷贝</li><li>引用类型数据的引用拷贝</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>var a = 1;
var b = {a: 1};
