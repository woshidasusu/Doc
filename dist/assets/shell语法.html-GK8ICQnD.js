import{_ as a,r as n,o as s,c as l,a as e,b as c,e as r,d}from"./app-fgtJnIYH.js";const o={},h=d(`<h1 id="shell-基本语法" tabindex="-1"><a class="header-anchor" href="#shell-基本语法" aria-hidden="true">#</a> shell 基本语法</h1><p>jenkins 上构建项目时，经常需要借助 shell 脚本，最近也经常跟服务器打交道，顺便记录些常用命令，方便查阅</p><h3 id="语法-变量" tabindex="-1"><a class="header-anchor" href="#语法-变量" aria-hidden="true">#</a> 语法-变量</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code># 定义变量
name=&#39;dasu&#39;
