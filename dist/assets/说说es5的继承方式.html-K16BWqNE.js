import{_ as i,o as n,c as e,d as s}from"./app-PjuKeMiB.js";const a={},d=s(`<h1 id="说说-es5-的几种继承方式" tabindex="-1"><a class="header-anchor" href="#说说-es5-的几种继承方式" aria-hidden="true">#</a> 说说 ES5 的几种继承方式</h1><p>在 ES6 还没出来前，让你写个继承，你会怎么写</p><p>比如，给你个场景：父类 A 具有属性 a 和方法 b，子类 B 继承父类 A</p><h3 id="es6-继承" tabindex="-1"><a class="header-anchor" href="#es6-继承" aria-hidden="true">#</a> ES6 继承</h3><p>用 ES6 来写的话，就很简单：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>class A {
    constructor() {
        this.a = &quot;A&quot;;
    }
