import{_ as d,r,o as a,c as v,a as e,b as i,e as s,d as l}from"./app-Zf-yBXw2.js";const c={},t=e("h1",{id:"题目-promise",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#题目-promise","aria-hidden":"true"},"#"),i(" 题目：Promise")],-1),m={id:"模拟实现一个-promise-finally",tabindex:"-1"},u=e("a",{class:"header-anchor",href:"#模拟实现一个-promise-finally","aria-hidden":"true"},"#",-1),o={href:"https://github.com/Advanced-Frontend/Daily-Interview-Question/issues/109",target:"_blank",rel:"noopener noreferrer"},b=e("span",{id:"1"},"模拟实现一个 Promise.finally",-1),h=l(`<p>跟 try-catch-finally 一样，finally 用于不管 Promise 最后状态如何都会执行的操作。而 Promise 只有两种状态变更，Resolved 或 Rejected，所以可以这么实现：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>Promise.prototype.finally = function(callback) {
