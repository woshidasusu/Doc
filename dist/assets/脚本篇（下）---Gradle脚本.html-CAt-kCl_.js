import{_ as d,r,o,c as l,a as e,b as i,e as n,d as s}from"./app-xJrSpaa5.js";const t={},u=e("h1",{id:"前言",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#前言","aria-hidden":"true"},"#"),i(" 前言")],-1),c={href:"https://www.jianshu.com/p/e0faba864cdd",target:"_blank",rel:"noopener noreferrer"},p=s(`<h1 id="gradle-脚本" tabindex="-1"><a class="header-anchor" href="#gradle-脚本" aria-hidden="true">#</a> Gradle 脚本</h1><p>需求场景跟上一篇一样，只是需要脚本能够帮我们遍历某个目录下的文件，然后分别针对每个文件执行 java 命令，再输出新的命名格式的文件即可，因此脚本涉及的方面仍然是：文件夹的遍历操作、字符串处理、执行 java 命令。下面开始学习吧：</p><h3 id="_1-遍历指定文件夹下的文件" tabindex="-1"><a class="header-anchor" href="#_1-遍历指定文件夹下的文件" aria-hidden="true">#</a> 1. 遍历指定文件夹下的文件</h3><h5 id="_1-1-files" tabindex="-1"><a class="header-anchor" href="#_1-1-files" aria-hidden="true">#</a> 1.1 files()</h5><p><strong>命令</strong>：</p><div class="language-groovy line-numbers-mode" data-ext="groovy"><pre class="language-groovy"><code>files(file1, file2, file3, file4...) .each {file -&gt;
	println file.name
}
