import{_ as i,r as s,o as d,c as r,a as e,b as a,e as l,d as c}from"./app-Zf-yBXw2.js";const t={},v={id:"题目-js异步解决方案的发展历程以及优缺点",tabindex:"-1"},o=e("a",{class:"header-anchor",href:"#题目-js异步解决方案的发展历程以及优缺点","aria-hidden":"true"},"#",-1),u={href:"https://github.com/Advanced-Frontend/Daily-Interview-Question/issues/11",target:"_blank",rel:"noopener noreferrer"},p=c(`<h3 id="_1-回调函数-callback" tabindex="-1"><a class="header-anchor" href="#_1-回调函数-callback" aria-hidden="true">#</a> 1. 回调函数（callback）</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>function loadData(callback) {
    $.ajax({
